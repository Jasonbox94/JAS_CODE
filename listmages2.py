...
try:
    ...
    if not image_files:
        ...
        fig, axes = plt.subplots(num_rows, images_per_row, figsize=(images_per_row * 1, num_rows * 1))
        fig.tight_layout(pad=1.0)  # 自動壓縮佈局間距
        ...
        for ax, file in zip(axes, image_files):
            ...
            ax.set_title(wrapped_title, fontproperties=font_prop, fontsize=8, pad=10, ha='center', y=-0.2)  # 設定對齊和高度
